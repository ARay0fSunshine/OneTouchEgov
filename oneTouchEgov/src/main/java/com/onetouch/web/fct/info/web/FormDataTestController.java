...
public class FormDataTestController {
	 ...
	 * "C:\\upload"; String uploadFolderPath = getFolder();
	 * 
	 * //make folder------------------------------- File uploadPath = new
	 * File(uploadFolder, uploadFolderPath); log.info("upload path: " + uploadPath
	 * ); System.out.println(uploadPath);
	 * 
	 * if(uploadPath.exists() == false) { uploadPath.mkdirs(); }
	 * 
	 * //make yyyy/MM/dd folder for(MultipartFile multipartFile : uploadFile) {
	 ...
	 * attachDTO.setFileName(uploadFileName); UUID uuid = UUID.randomUUID();
	 ...
	 * }//end catch }//end for return new ResponseEntity<>(list, HttpStatus.OK); }
	 */
